...
var _lazyLoad = _interopRequireDefault(__webpack_require__(46));
...
var _gsap = _interopRequireDefault(__webpack_require__(13));

var _utils = __webpack_require__(9);

var _common = _interopRequireDefault(__webpack_require__(18));

var _signupInfo = _interopRequireDefault(__webpack_require__(32));

var _banner = _interopRequireDefault(__webpack_require__(33));

var _slogan = _interopRequireDefault(__webpack_require__(34));

var _colors = _interopRequireDefault(__webpack_require__(35));

var _battery = _interopRequireDefault(__webpack_require__(36));

var _distance = _interopRequireDefault(__webpack_require__(37));

var _power = _interopRequireDefault(__webpack_require__(38));

var _features = _interopRequireDefault(__webpack_require__(39));

var _smartkeys = _interopRequireDefault(__webpack_require__(40));

var _maintain = _interopRequireDefault(__webpack_require__(41));

var _brake = _interopRequireDefault(__webpack_require__(42));

var _comparision = _interopRequireDefault(__webpack_require__(43));

var _gallery = _interopRequireDefault(__webpack_require__(44));

var _view = _interopRequireDefault(__webpack_require__(45));
...
function () {
  ...
  function Demo() {
    ...
    window.TweenMax = _gsap.default; // Page Listener

    window.YADEAXmenListener = new _utils.pageListener(); // Common Behavior

    var common = new _common.default();
    var signupInfo = new _signupInfo.default(); // Section Behaviors

    var banner = new _banner.default();
    var slogan = new _slogan.default();
    var color = new _colors.default();
    ...
    var smartkey = new _smartkeys.default();
    var brake = new _brake.default();
    var maintain = new _maintain.default();
    var comparision = new _comparision.default();
    var view360 = new _view.default();
    ...
    value: function ScrollOutSetup() {
      (0, _scrollOut.default)({
        onShown: function onShown(el) {
          ...
          var elementID = $(el).attr("id"); // Emit event when section inside the view

          YADEAXmenListener.emit("".concat(elementID, "-anim"));
        },
        onHidden: function onHidden(el) {
          var elementID = $(el).attr("id"); // Emit event when section out of the view

          YADEAXmenListener.emit("".concat(elementID, "-hide"));
        },
        threshold: 0.125
      });
      (0, _scrollOut.default)({
...
function () {
  ...
  _createClass(Home, [{
    key: "bindEvents",
    value: function bindEvents() {
      this.PayModalSetup(); // Sub Menu Toggle On Mobile
    ...
    value: function SetupMbMenuToggle() {
      ...
      this.$menuToggleButton.on("click", function (e) {
        if (_this.allowToggle) {
          ...
          if (!_this.$subHeader.hasClass("showing-sub-menu")) {
            _this.$subHeader.addClass("showing-sub-menu");

            _this.$subMenu.slideDown("fast");
          } else {
            _this.$subHeader.removeClass("showing-sub-menu");

            _this.$subMenu.slideUp("fast");
          }
        }
      });
    ...
    value: function PayModalSetup() {
      ...
      this.$openPayModalBtn.on("click", function () {
        ...
        _this2.$payModal.addClass("active");
      });
      this.$closePayModalBtn.on("click", function () {
        $("body").removeClass("active");

        _this2.$payModal.removeClass("active");
      });
    }
  }]);
  ...
  _createClass(Banner, [{
    ...
    value: function InitSection() {
      ...
      TweenMax.set(this.$MainContent, {
        autoAlpha: 0,
        y: window.innerWidth * 0.0075
      });
      this.BannerAnimation.to(this.$BannerBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      });
      this.BannerAnimation.to(this.$MainContent, 0.5, {
        autoAlpha: 1,
        y: 0
      }, "-=0.15");
    }
...
function () {
  ...
  function Slogan() {
    ...
    this.$OpenProductModalBtn = this.$SloganMainContent.find(".open-gallery-popup"); // Modal Elements
    ...
    this.SloganAnimTimeline = new TimelineMax({
      ...
      onComplete: function onComplete() {
        _this.ProductModalTogglingSetup();
      }
    });
    this.bindEvents();
  }
  ...
  _createClass(Slogan, [{
    ...
    value: function bindEvents() {
      ...
      // Product Modal Setup
      this.ProductModalSetup(); // Animation Setup

      this.InitSection();
      YADEAXmenListener.on("yadea-xmen-slogan-anim", function () {
        _this2.SloganAnimTimeline.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      // Set Init State
      TweenMax.set(this.$SloganBg, {
        autoAlpha: 0,
        scale: 1.2
      });
      TweenMax.set(this.$SloganMainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      }); // Animation Build

      this.SloganAnimTimeline.add("anim-start");
      this.SloganAnimTimeline.to(this.$SloganBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, "anim-start");
      this.SloganAnimTimeline.staggerTo(this.$SloganMainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "anim-start");
    }
  }, {
    key: "ProductModalTogglingSetup",
    value: function ProductModalTogglingSetup() {
      var _this3 = this;

      this.$OpenProductModalBtn.on("click", function (e) {
        ...
        var dataTarget = $target.data("product"); // Update and Show Modal

        _this3.OpenModal(dataTarget);

        _this3.$ProductPopup.addClass("show-modal");
      });
    }
  }, {
    key: "ProductModalSetup",
    value: function ProductModalSetup() {
      var _this4 = this;

      // Close Modal
      this.$CloseModal.on("click", function () {
        _this4.$ProductPopup.removeClass("show-modal");
      }); // Modal Select Click

      this.$ModalSelectItem.on("click", function (e) {
        var $target = $(e.target);

        if (!$target.hasClass("active")) {
          var dataTarget = $target.data("product"); // Toggling Active Button

          _this4.OpenModal(dataTarget);
        }
      });
    }
  }, {
    ...
    value: function OpenModal() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "xmen";
      this.$ModalSelectItem.removeClass("active");
      $("#product-swap-to-".concat(type)).addClass("active"); // Update Decoration

      this.$ModalSelectDecor.removeClass("active-xmen active-x5");
      this.$ModalSelectDecor.addClass("active-".concat(type)); // Audate Layout

      $(".product-image-modal .colors-layout.active").removeClass("active");
      $("#".concat(type, "-product-images-layout")).addClass("active");
    }
  }]);
...
function () {
  ...
  function Colors() {
    ...
    // Elements
    this.$ColorSection = $("#yadea-xmen-variation"); //Background Elements
    ...
    this.$SwitchProductDecor = this.$ColorControl.find(".decor-line"); // Color List Group

    this.$XMenColorList = this.$ColorSection.find(".color-group-list.for-xmen");
    this.$X5ColorList = this.$ColorSection.find(".color-group-list.for-x5"); // Switch Color Button

    this.$SwitchColorXmenBtn = this.$XMenColorList.find(".color-item");
    this.$SwitchColorX5Btn = this.$X5ColorList.find(".color-item"); // Bike Images
    ...
    this.$PagingX5CurrentPage = this.$PagingX5.find(".current-page"); // Matching Info To Do Animation
  ...
  _createClass(Colors, [{
    ...
    value: function bindEvents() {
      ...
      YADEAXmenListener.on("yadea-xmen-variation-anim", function () {
        _this.isAnimating = true;

        _this.DoSwitchAnimation();
      });
    }
    /* ===================================
     *  METHODS
    ...
    key: "SwitchProductSetup",
    value: function SwitchProductSetup() {
      var _this2 = this;

      // Swapping Between Product Button Click
      this.$SwitcProductBtn.on("click", function (e) {
        if (!_this2.isAnimating) {
          _this2.isAnimating = true;
          var $targetEl = $(e.target); // Note current bike, switch bike, else ignore

          if (!$targetEl.hasClass("active")) {
            // Get Product Name
            var targetName = $targetEl.data("select"); // Toggling Product Item Active

            _this2.$SwitcProductBtn.removeClass("active");

            $targetEl.addClass("active");

            switch (targetName) {
              case "xmen":
                _this2.CurrentMatching = Object.assign({}, _this2.MATCHING_INFO["xmen-blue"]);

                _this2.$SwitchProductDecor.removeClass("active-2").addClass("active-1");

                _this2.DoSwitchAnimation();

                break;

              case "x5":
                _this2.CurrentMatching = Object.assign({}, _this2.MATCHING_INFO["x5-white"]);
                $targetEl.addClass("active");

                _this2.$SwitchProductDecor.removeClass("active-1").addClass("active-2");
      ...
      this.$SwitchColorXmenBtn.on("click", function (e) {
        if (!_this2.isAnimating) {
          // Lock the flag
          _this2.isAnimating = true; // Check The Click Target
          ...
          if (!$clickTarget.hasClass("active")) {
            var nextTargetValue = $clickTarget.data("target");
            _this2.CurrentMatching = Object.assign({}, _this2.MATCHING_INFO[nextTargetValue]);

            _this2.$SwitchColorXmenBtn.removeClass("active");
      ...
      this.$SwitchColorX5Btn.on("click", function (e) {
        if (!_this2.isAnimating) {
          // Lock the flag
          _this2.isAnimating = true; // Check The Click Target
          ...
          if (!$clickTarget.hasClass("active")) {
            ...
            _this2.$SwitchColorX5Btn.removeClass("active");
      ...
      this.$PagingXmenNext.on("click", function (e) {
        if (_this2.OldMatching !== null) {
          _this2.GetNext("xmen");
        }
      });
      this.$PagingXmenPrev.on("click", function (e) {
        if (_this2.OldMatching !== null) {
          _this2.GetPrev("xmen");
        }
      });
      this.$PagingX5Prev.on("click", function (e) {
        if (_this2.OldMatching !== null) {
          _this2.GetPrev("x5");
        }
      });
      this.$PagingX5Next.on("click", function (e) {
        if (_this2.OldMatching !== null) {
          _this2.GetNext("x5");
        }
      });
    ...
    key: "DoSwitchAnimation",
    value: function DoSwitchAnimation() {
      var _this3 = this;

      var SwitchingTimeline = new TimelineMax({
        onComplete: function onComplete() {
          _this3.OldMatching = Object.assign({}, _this3.CurrentMatching);
          _this3.isAnimating = false;
        }
      });
      var isAnimatingName = this.OldMatching == null || this.OldMatching.name !== this.CurrentMatching.name; // Starting Label

      SwitchingTimeline.add("anim-start"); // Hide Old Elements First

      if (this.OldMatching !== null) {
        SwitchingTimeline.add("hide-start");
        SwitchingTimeline.to(this.BgElements[this.OldMatching.bg], 0.25, {
          autoAlpha: 0
        }, "hide-start");
        ...
        switch (this.OldMatching.name) {
          case "xmen":
            // Update New Page
            this.$PagingXmenCurrentPage.html(this.CurrentMatching.page); // Old Bike Go Away, then back to init position

            SwitchingTimeline.to(this.XmenImages[this.OldMatching.bike], 0.25, {
              autoAlpha: 0,
              x: -window.innerWidth * 0.05,
              onComplete: function onComplete() {
                TweenMax.set(_this3.XmenImages[_this3.OldMatching.bike], {
                  autoAlpha: 0,
                  x: window.innerWidth * 0.1
                });
              }
            }, "hide-start"); // Need to do name change too

            if (isAnimatingName) {
              // Fade out the name
              SwitchingTimeline.to(this.ProductNames.xmen[0], 0.25, {
                autoAlpha: 0,
                x: window.innerWidth * 0.05
              }, "hide-start"); // Fade out the name

              SwitchingTimeline.to(this.ProductNames.xmen[1], 0.25, {
                autoAlpha: 0,
                x: -window.innerWidth * 0.05,
                onComplete: function onComplete() {
                  TweenMax.set(_this3.ProductNames.xmen[0], {
                    autoAlpha: 0,
                    x: -window.innerWidth * 0.1
                  });
                  TweenMax.set(_this3.ProductNames.xmen[1], {
                    autoAlpha: 0,
                    x: window.innerWidth * 0.1
                  });
                }
              }, "hide-start"); // Fade out color set

              SwitchingTimeline.to(this.$XMenColorList, 0.25, {
                autoAlpha: 0,
                onComplete: function onComplete() {
                  TweenMax.set(_this3.$XMenColorList, {
                    autoAlpha: 0,
                    y: window.innerWidth * 0.025
                  });

                  _this3.$SwitchColorXmenBtn.removeClass("active");

                  $(".color-group-list.for-xmen .color-item.blue").addClass("active");
                }
              }); // Fade out old Paging

              SwitchingTimeline.to(this.$PagingXmen, 0.25, {
                autoAlpha: 0,
          ...
          case "x5":
            // Update New Page
            this.$PagingX5CurrentPage.html(this.CurrentMatching.page); // Old Bike Go Away, then back to init position

            SwitchingTimeline.to(this.X5Images[this.OldMatching.bike], 0.25, {
              autoAlpha: 0,
              x: -window.innerWidth * 0.05,
              onComplete: function onComplete() {
                TweenMax.set(_this3.X5Images[_this3.OldMatching.bike], {
                  autoAlpha: 0,
                  x: window.innerWidth * 0.1
                });
              }
            ...
            if (isAnimatingName) {
              SwitchingTimeline.to(this.ProductNames.x5, 0.25, {
                autoAlpha: 0,
                x: window.innerWidth * 0.05,
                onComplete: function onComplete() {
                  TweenMax.set(_this3.ProductNames.x5, {
                    autoAlpha: 0,
                    x: window.innerWidth * 0.1
                  });
                }
              ...
              SwitchingTimeline.to(this.$X5ColorList, 0.25, {
                autoAlpha: 0,
                onComplete: function onComplete() {
                  TweenMax.set(_this3.$X5ColorList, {
                    autoAlpha: 0,
                    y: window.innerWidth * 0.025
                  });

                  _this3.$SwitchColorX5Btn.removeClass("active");

                  $(".color-group-list.for-x5 .color-item.white").addClass("active");
                }
              }); // Fade out old Paging

              SwitchingTimeline.to(this.$PagingX5, 0.25, {
                autoAlpha: 0,
                y: window.innerWidth * 0.015
              }, "hide-start");
            }
      ...
      SwitchingTimeline.to(this.BgElements[this.CurrentMatching.bg], 0.75, {
        autoAlpha: 1
      }, "anim-start"); // The current name is different

      switch (this.CurrentMatching.name) {
        case "xmen":
          if (isAnimatingName) {
            // Show Bike Name
            SwitchingTimeline.to([this.ProductNames.xmen[0], this.ProductNames.xmen[1]], 0.5, {
              autoAlpha: 1,
              x: 0
            }, "anim-start+=0.5"); // Show Color Listing

            SwitchingTimeline.to(this.$XMenColorList, 0.5, {
              autoAlpha: 1,
              y: 0
            }, "anim-start+=0.5"); // Show New Paging

            SwitchingTimeline.to(this.$PagingXmen, 0.5, {
              autoAlpha: 1,
              y: 0
            }, "anim-start+=0.5");
          }

          SwitchingTimeline.to(this.XmenImages[this.CurrentMatching.bike], 0.7, {
            autoAlpha: 1,
            x: 0
          }, "-=0.2");
          break;
        ...
        case "x5":
          ...
          if (isAnimatingName) {
            // Show New Name
            SwitchingTimeline.to(this.ProductNames.x5, 0.5, {
              autoAlpha: 1,
              x: 0
            }, "anim-start+=0.5"); // Show Color Listing

            SwitchingTimeline.to(this.$X5ColorList, 0.5, {
              autoAlpha: 1,
              y: 0
            }, "anim-start+=0.5"); // Show New Paging

            SwitchingTimeline.to(this.$PagingX5, 0.5, {
              autoAlpha: 1,
              y: 0
            }, "anim-start+=0.5");
          }

          SwitchingTimeline.to(this.X5Images[this.CurrentMatching.bike], 0.7, {
            autoAlpha: 1,
            x: 0
          }, "-=0.2");
          break;
    ...
    value: function InitState() {
      // Background
      for (var item in this.BgElements) {
        TweenMax.set(this.BgElements[item], {
          autoAlpha: 0
        });
      } // Name


      TweenMax.set([this.ProductNames.x5, this.ProductNames.xmen[0]], {
        autoAlpha: 0,
        x: -window.innerWidth * 0.1
      });
      TweenMax.set(this.ProductNames.xmen[1], {
        autoAlpha: 0,
        x: window.innerWidth * 0.1
      }); // Bike Images

      for (var _item in this.XmenImages) {
        console.log(this.XmenImages[_item]);
        TweenMax.set(this.XmenImages[_item], {
          autoAlpha: 0,
          x: window.innerWidth * 0.1
        });
      }

      for (var _item2 in this.X5Images) {
        console.log(this.X5Images[_item2]);
        TweenMax.set(this.X5Images[_item2], {
          autoAlpha: 0,
          x: window.innerWidth * 0.1
        });
      }

      TweenMax.set([this.$XMenColorList, this.$X5ColorList], {
        autoAlpha: 0,
        y: window.innerWidth * 0.025
      });
      TweenMax.set([this.$PagingX5, this.$PagingXmen], {
        autoAlpha: 0,
        y: window.innerWidth * 0.015
      });
    }
    ...
    value: function GetNext() {
      ...
      if (type == "xmen") {
        var _arr2 = Object.entries(this.MATCHING_INFO);
        ...
        for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
          ...
          if (value.page === this.OldMatching.page + 1 && value.name == "xmen") {
            ...
            $(".color-item.xmen[data-target=".concat(key, "]")).addClass("active");
            this.DoSwitchAnimation();
          }
        }
      } else {
        var _arr3 = Object.entries(this.MATCHING_INFO);
        ...
        for (var _i3 = 0; _i3 < _arr3.length; _i3++) {
          ...
          if (_value.page === this.OldMatching.page + 1 && _value.name == "x5") {
            this.isAnimating = true;
            this.CurrentMatching = Object.assign({}, _value);
            this.$SwitchColorX5Btn.removeClass("active");
            $(".color-item.x5[data-target=".concat(_key, "]")).addClass("active");
            this.DoSwitchAnimation();
          }
        }
      }
    ...
    value: function GetPrev() {
      ...
      if (type == "xmen") {
        var _arr4 = Object.entries(this.MATCHING_INFO);
        ...
        var _arr5 = Object.entries(this.MATCHING_INFO);
        ...
        for (var _i5 = 0; _i5 < _arr5.length; _i5++) {
          ...
          if (_value2.page === this.OldMatching.page - 1 && _value2.name === "x5") {
            this.isAnimating = true;
            this.CurrentMatching = Object.assign({}, _value2);
            this.$SwitchColorX5Btn.removeClass("active");
            $(".color-item.x5[data-target=".concat(_key2, "]")).addClass("active");
            this.DoSwitchAnimation();
          }
        }
      }
...
function () {
  ...
  function Battery() {
    ...
    // Elements Variables
    this.$BatterySection = $("#yadea-xmen-battery"); // Background Layer

    this.$MainBg = this.$BatterySection.find(".bg-holder"); // Effect Layer
    ...
    this.$Feature_Value = this.$FeatureIcoLayer.find(".feature-detail .value"); // Main Content

    this.$MainContent = this.$BatterySection.find(".main-content");
    this.$MainContent_Context = this.$MainContent.find("> *");
    this.ShowingEffect = new TimelineMax({
      pause: true
    });
    this.bindEvents();
  }
  ...
  _createClass(Battery, [{
    ...
    value: function InitSection() {
      // Preset Init State
      TweenMax.set(this.$MainBg, {
        autoAlpha: 0,
        scale: 1.1
      });
      TweenMax.set([this.$WaveLayer, this.$Feature_Ico], {
        autoAlpha: 0
      });
      TweenMax.set([this.$Feature_Label, this.$Feature_Value], {
        autoAlpha: 0,
        y: -window.innerWidth * 0.01
      });
      TweenMax.set(this.$MainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      }); // Animation Build

      this.ShowingEffect.add("anim-start");
      this.ShowingEffect.staggerTo(this.$MainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "anim-start");
      this.ShowingEffect.to(this.$MainBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, "anim-start");
      this.ShowingEffect.to(this.$WaveLayer, 0.5, {
        autoAlpha: 1
      }, "-=0.2");
      this.ShowingEffect.to(this.$Feature_Ico, 0.5, {
        autoAlpha: 1
      }, "-=0.2");
      this.ShowingEffect.to([this.$Feature_Label, this.$Feature_Value], 0.35, {
        autoAlpha: 1,
        y: 0
      }, "-=0.25");
    }
...
function () {
  ...
  function Distance() {
    ...
    this.DistanceAnimation = new TimelineMax({
      ...
      onComplete: function onComplete() {
        ...
        _this.$DistanceMainContent.addClass("anim");
      }
    });
    this.bindEvents();
  }
  ...
  _createClass(Distance, [{
    ...
    value: function InitSection() {
      // Set Init State
      TweenMax.set(this.$DistacenMainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
      TweenMax.set(this.$DistanceBg, {
        autoAlpha: 0,
        scale: 1.1
      });
      TweenMax.set(this.$DistanceBikeImage, {
        x: -window.innerWidth * 0.7
      });
      TweenMax.set(this.$DistanceTagHolder, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      }); // Animation Build

      this.DistanceAnimation.add("anim-start");
      this.DistanceAnimation.to(this.$DistanceBg, 0.75, {
        scale: 1,
        autoAlpha: 1
      }, "anim-start");
      this.DistanceAnimation.staggerTo(this.$DistacenMainContent_Context, 0.5, {
        y: 0,
        autoAlpha: 1
      }, 0.2, "anim-start");
      this.DistanceAnimation.to(this.$DistanceBikeImage, 1.5, {
        x: 0,
        autoAlpha: 1,
        ease: Power2.easeOut
      }, "-=0.4");
      this.DistanceAnimation.to(this.$DistanceTagHolder, 0.5, {
        y: 0,
        autoAlpha: 1,
        ease: Power2.easeOut
      }, "-=0.8");
...
function () {
  ...
  function Power() {
    ...
    this.PowerAnimTimeline = new TimelineMax({
      paused: true
    });
    this.bindEvents();
  }
  ...
  _createClass(Power, [{
    ...
    value: function bindEvents() {
      ...
      YADEAXmenListener.on("yadea-xmen-power-anim", function () {
        ...
        _this.PowerAnimTimeline.play();
      });
      YADEAXmenListener.on("yadea-xmen-power-smartkey-anim", function () {
        TweenMax.to(_this.$PowerBg, 0.75, {
          autoAlpha: 1,
          scale: 1
        }, "anim-start");
      });
    ...
    value: function InitSection() {
      ...
      this.PowerAnimTimeline.staggerTo(this.$PowerMainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "anim-start+=0.3");
    }
...
function () {
  ...
  function Features() {
    ...
    // Elements Variables
    this.$FeatureSection = $("#yadea-xmen-features"); // Name List
    ...
    this.$FeatureDecorLine = this.$FeatureNameList.find(".decor-underline"); // Description Detail

    this.$FeatureDescription = this.$FeatureSection.find(".feature-description-list");
    this.$FeatureDescription_Item = this.$FeatureSection.find(".description-item"); // Images

    this.$FeatureImages = this.$FeatureSection.find(".feature-images-list");
    this.$FeatureImages_Item = this.$FeatureImages.find(".image-item "); // Main Appear Timeline

    this.FeaturesTimeline = new TimelineMax({
      paused: true,
      onComplete: this.BindSwappingFeature()
    });
    this.bindEvents();
  }
  /* ===================================
  ...
  _createClass(Features, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      YADEAXmenListener.on("yadea-xmen-features-anim", function () {
        // TweenMax.staggerTo(this.$PowerMainContent_Context, 0.5, { autoAlpha: 1, y: 0 }, 0.2);
        _this.FeaturesTimeline.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      ...
      this.FeaturesTimeline.staggerTo([this.$FeatureNameList, this.$FeatureDescription, this.$FeatureImages], 0.75, {
        autoAlpha: 1,
        y: 0
      }, 0.2);
    }
  }, {
    key: "BindSwappingFeature",
    value: function BindSwappingFeature() {
      var _this2 = this;

      this.$FeatureNameList_Item.on("click", function (e) {
        var $target = $(e.target);

        if (!$target.hasClass("active")) {
          // Get Next Target Name
          var dataTarget = $target.data("feature"); // Swap to next active

          _this2.$FeatureNameList_Item.removeClass("active");

          $target.addClass("active");

          _this2.$FeatureDecorLine.removeClass("active-anti-shock active-bike-frame active-bike-under active-water-resistant active-bike-engine active-bike-wheel");

          _this2.$FeatureDecorLine.addClass("active-".concat(dataTarget)); // Update Description


          _this2.$FeatureDescription_Item.removeClass("active");

          $(".description-item#".concat(dataTarget, "-detail")).addClass("active"); // Update Image

          _this2.$FeatureImages_Item.removeClass("active");

          $(".image-item#".concat(dataTarget, "-image")).addClass("active");
        }
      });
    }
  }]);
...
function () {
  ...
  function SmartKey() {
    ...
    this.$SmartkeyMainContent_Context = this.$SmartkeyMainContent.find("> *"); // Smartkey Elements
    ...
    this.$BikeImage_Shadow = this.$SmartkeySection.find(".bike-shadow-img"); // Main Appear Timeline

    this.SmartKeyTimeline = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.SmartKeyAnimationSetup();
      }
    });
  ...
  _createClass(SmartKey, [{
    ...
    value: function InitSection() {
      // Init First State
      TweenMax.set(this.$SmartkeyMainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
      TweenMax.set([this.$RemoteControl_Wave1, this.$RemoteControl_Wave2], {
        autoAlpha: 0,
        scale: 0.5
      });
      TweenMax.set(this.$BikeImage_Shadow, {
        autoAlpha: 0
      });
      TweenMax.set(this.$RemoteControl_Image, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
      TweenMax.set(this.$BikeImage_Bike, {
        autoAlpha: 0,
        y: -window.innerWidth * 0.05
      }); // Build Init Timeline

      this.SmartKeyTimeline.add("anim-start");
      this.SmartKeyTimeline.staggerTo(this.$SmartkeyMainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "anim-start");
      this.SmartKeyTimeline.to(this.$BikeImage_Bike, 0.75, {
        autoAlpha: 1,
        y: 0
      }, "anim-start+=0.7");
      this.SmartKeyTimeline.to(this.$BikeImage_Shadow, 0.5, {
        autoAlpha: 0.15
      }, "anim-start+=1");
      this.SmartKeyTimeline.to(this.$RemoteControl_Image, 0.5, {
        autoAlpha: 1,
        y: 0
      }, "-=0.1"); // Build Smartkey Effect Anim

      this.SmartKeyEffectTimeline.add("anim-start");
      this.SmartKeyEffectTimeline.fromTo(this.$RemoteControl_Wave1, 0.3, {
        autoAlpha: 0,
        scale: 0.5,
      ...
      this.SmartKeyEffectTimeline.to(this.$RemoteControl_Wave1, 0.6, {
        autoAlpha: 0,
        scale: 2,
        ease: Power0.easeNone
      }, "anim-start+=0.3");
      this.SmartKeyEffectTimeline.fromTo(this.$RemoteControl_Wave2, 0.3, {
        autoAlpha: 0,
        scale: 0.5,
        ease: Power0.easeNone
      }, {
      ...
      this.SmartKeyEffectTimeline.to(this.$RemoteControl_Wave2, 0.6, {
        autoAlpha: 0,
        scale: 2,
        ease: Power0.easeNone
      }, "anim-start+=0.6");
      this.SmartKeyEffectTimeline.to(this.$BikeImage_Shadow, 0.3, {
        autoAlpha: 1
      }, '-=0.4');
      this.SmartKeyEffectTimeline.to(this.$BikeImage_Shadow, 0.3, {
        autoAlpha: 0.5
    ...
    key: "SmartKeyAnimationSetup",
    value: function SmartKeyAnimationSetup() {
...
function () {
  ...
  _createClass(Maintain, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      YADEAXmenListener.on("yadea-xmen-maintain-anim", function () {
        _this.MaintainAnimTimline.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      // Set Init State
      TweenMax.set(this.$MaintainMainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
      TweenMax.set(this.$MaintainBg, {
        autoAlpha: 0,
        scale: 1.1
      });
      this.MaintainAnimTimline.add("anim-start");
      this.MaintainAnimTimline.staggerTo(this.$MaintainMainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "anim-start");
      this.MaintainAnimTimline.to(this.$MaintainBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, "anim-start");
    }
...
function () {
  ...
  function Maintain() {
    ...
    this.$BrakeAnimTimeline = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.$BrakeEffectTimeline.play();
      }
    });
  ...
  _createClass(Maintain, [{
    ...
    value: function InitSection() {
      // Set Init State
      TweenMax.set(this.$BrakeMainContent_Context, {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
      TweenMax.set(this.$BrakeMainContent, {
        autoAlpha: 0,
        x: -window.innerWidth * 0.3
      });
      TweenMax.set(this.$BrakeBg, {
        autoAlpha: 0,
        scale: 1.2
      });
      TweenMax.set(this.$BrakeBg_Effect, {
        autoAlpha: 0
      });
      this.$BrakeAnimTimeline.add("anim-start");
      this.$BrakeAnimTimeline.to(this.$BrakeBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, "anim-start");
      this.$BrakeAnimTimeline.to(this.$BrakeMainContent, 0.75, {
        autoAlpha: 1,
        x: 0
      }, "anim-start");
      this.$BrakeAnimTimeline.staggerTo(this.$BrakeMainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, "-=0.1");
      this.$BrakeEffectTimeline.add("anim-start");
      this.$BrakeEffectTimeline.fromTo(this.$BrakeBg_Effect, 0.35, {
        autoAlpha: 0,
        scale: 0.99,
        ease: Power3.easeIn
      }, {
      ...
      this.$BrakeEffectTimeline.to(this.$BrakeBg_Effect, 0.4, {
        autoAlpha: 0
      }, "+=2");
    }
  }]);
  ...
  _createClass(Comparision, [{
    ...
    value: function bindEvents() {
      ...
      YADEAXmenListener.on("yadea-xmen-comparision-anim", function () {
        TweenMax.staggerTo([_this.$ComparisionTitle, _this.$ComparisionLayout], 0.5, {
          autoAlpha: 1,
          y: 0,
          onComplete: function onComplete() {
            _this.BindComparisionSwitch();
          }
        }, 0.2);
      });
    }
    ...
    value: function InitSection() {
      // Set Init State
      TweenMax.set([this.$ComparisionTitle, this.$ComparisionLayout], {
        autoAlpha: 0,
        y: window.innerWidth * 0.02
      });
    }
  }, {
    key: "BindComparisionSwitch",
    value: function BindComparisionSwitch() {
      var _this2 = this;

      this.$AspectBtn.on("click", function (e) {
        var $target = $(e.target);

        if (!$target.hasClass("active")) {
          var dataTarget = $target.data("aspect");

          _this2.$AspectBtn.removeClass("active");

          $target.addClass("active"); // Hide Old Aspect

          _this2.$AspectRow.removeClass("active");

          $("#".concat(dataTarget, "-aspect-table")).addClass("active");

          _this2.$AspectDecorLine.removeClass("size-active frame-active engine-active performance-active utils-active");

          _this2.$AspectDecorLine.addClass("".concat(dataTarget, "-active"));
        }
      });
    }
  }]);
...
function () {
  ...
  _createClass(Gallery, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      YADEAXmenListener.on("yadea-xmen-gallery-layout-anim", function () {
        _this.GalleryAnimation.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    value: function InitSection() {
      ...
      this.GalleryAnimation.staggerTo(this.$GalleryGroup_Item, 1.25, {
        rotationY: 180
      }, 0.15, "anim-start");
      this.GalleryAnimation.staggerTo(this.$GalleryGroup_Item, 1.25, {
        rotationY: 0
...
function () {
  ...
  function View360() {
    ...
    window.ProductViewPageListener = new _utils.pageListener(); // Elements Variables
    ...
    this.ViewX5ProductAnim = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.blockInteraction = false; //Reset Xmen View

        _this.ViewXmenProductAnim.stop();

        _this.ViewXmenProductAnim.progress(0); //Reset Xmen Rotation Product
    ...
    this.ViewXmenProductAnim = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.blockInteraction = false; //Reset X5 View

        _this.ViewX5ProductAnim.stop();

        _this.ViewX5ProductAnim.progress(0); //Reset Xmen Rotation Product
    ...
    this.MainAnimation = new TimelineMax({
      paused: true,
      onComplete: function onComplete() {
        _this.ProductViewSetup();

        _this.ProductToggleSetup();
      }
    }); // Rotating Variables
  ...
  _createClass(View360, [{
    ...
    value: function bindEvents() {
      ...
      this.InitSection();
      YADEAXmenListener.on('yadea-xmen-360-view-anim', function () {
        _this2.MainAnimation.play();
      });
    }
    /* ===================================
     *  METHODS
    ...
    key: "SwitchToProduct",
    value: function SwitchToProduct() {
      var product = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "xmen";
    ...
    value: function InitSection() {
      ...
      TweenMax.set([this.$X5ViewGroup, this.$XMenViewGroup], {
        autoAlpha: 0,
        x: window.innerWidth * 0.075
      });
      TweenMax.set([this.$X5NameImage, this.$XMenNameImage_Front], {
        autoAlpha: 0,
        x: -window.innerWidth * 0.075
      });
      TweenMax.set(this.$XMenNameImage_Back, {
        autoAlpha: 0,
        x: window.innerWidth * 0.075
      });
      TweenMax.set([this.$X5ViewBg, this.$XmenViewBg], {
        autoAlpha: 0,
        scale: 1.1
      }); //Animation Build
      ...
      this.MainAnimation.to(this.$XmenViewBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, 'anim-start');
      this.MainAnimation.staggerTo(this.$MainContent_Context, 0.5, {
        autoAlpha: 1,
        y: 0
      }, 0.2, 'anim-start');
      this.MainAnimation.to([this.$XMenNameImage_Front, this.$XMenNameImage_Back], 0.5, {
        autoAlpha: 1,
        x: 0
      });
      this.MainAnimation.to(this.$XMenViewGroup, 0.5, {
        autoAlpha: 1,
        x: 0
      }, '-=0.3'); // Animation To X5

      this.ViewX5ProductAnim.add('anim-start'); // Xmen out

      this.ViewX5ProductAnim.to(this.$XmenViewBg, 0.5, {
        autoAlpha: 0,
        scale: 1.1
      }, 'anim-start');
      this.ViewX5ProductAnim.to([this.$XMenNameImage_Front, this.$XMenViewGroup], 0.5, {
        autoAlpha: 0,
        x: -window.innerWidth * 0.075
      }, 'anim-start');
      this.ViewX5ProductAnim.to(this.$XMenNameImage_Back, 0.5, {
        autoAlpha: 0,
        x: window.innerWidth * 0.075
      }, 'anim-start'); //X5 In

      this.ViewX5ProductAnim.to(this.$X5ViewBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, 'anim-start+=0.25');
      this.ViewX5ProductAnim.to(this.$X5NameImage, 0.5, {
        autoAlpha: 1,
        x: 0
      });
      this.ViewX5ProductAnim.to(this.$X5ViewGroup, 0.5, {
        autoAlpha: 1,
        x: 0
      }, '-=0.3'); // Animation To Xmen

      this.ViewXmenProductAnim.add('anim-start'); // X5 Out

      this.ViewXmenProductAnim.to(this.$X5ViewBg, 0.5, {
        autoAlpha: 0,
        scale: 1.1
      }, 'anim-start');
      this.ViewXmenProductAnim.to(this.$X5NameImage, 0.5, {
        autoAlpha: 0,
        x: window.innerWidth * 0.075
      }, 'anim-start');
      this.ViewXmenProductAnim.to(this.$X5ViewGroup, 0.5, {
        autoAlpha: 0,
        x: -window.innerWidth * 0.075
      }, 'anim-start'); // Xmen In

      this.ViewXmenProductAnim.to(this.$XmenViewBg, 0.75, {
        autoAlpha: 1,
        scale: 1
      }, 'anim-start+=0.25');
      this.ViewXmenProductAnim.to([this.$XMenNameImage_Front, this.$XMenNameImage_Back], 0.75, {
        autoAlpha: 1,
        x: 0
      });
      this.ViewXmenProductAnim.fromTo(this.$XMenViewGroup, 0.5, {
        autoAlpha: 0,
        x: window.innerWidth * 0.075
      }, {
        autoAlpha: 1,
    ...
    key: "ProductToggleSetup",
    value: function ProductToggleSetup() {
      var _this3 = this;

      this.$ProductToggleBtn.on('click', function (e) {
        // Get Correct element
        var $clickTarget = $(e.target);
        ...
        if (!$clickTarget.hasClass('active')) {
          // Block Interaction 
          _this3.blockInteraction = true; // Button Process

          var dataTarget = $clickTarget.data('bike');
          _this3.currentProd = dataTarget;

          _this3.$ProductToggleBtn.removeClass('active');

          $clickTarget.addClass('active');

          _this3.$ProductSelectDecor.removeClass('active-xmen active-x5');

          _this3.$ProductSelectDecor.addClass("active-".concat(_this3.currentProd)); // Do the animation


          _this3.SwitchToProduct(_this3.currentProd);
        }
      });
    }
  }, {
    key: "ProductViewSetup",
    value: function ProductViewSetup() {
      var _this4 = this;

      // Mouse Down, Start Receive Input
      this.$ViewProductSection.on('mousedown touchstart', function (e) {
        if (!_this4.blockInteraction) {
          _this4.isReceiveInput = true;
          _this4.oldx = e.pageX;

          _this4.$NameFrontLayer.css('z-index', '1');
        }
      }); // Mouse up, stop receive input

      this.$ViewProductSection.on('mouseup touchend', function (e) {
        _this4.isReceiveInput = false;

        _this4.$NameFrontLayer.css('z-index', '3');
      });
      this.$ViewProductSection.on("mousemove touchmove", function (e) {
        var pageX = e.pageX;
        ...
        if (_this4.isReceiveInput) {
          if (pageX > _this4.oldx) {
            ProductViewPageListener.emit('right');
          } else if (pageX < _this4.oldx) {
      ...
      ProductViewPageListener.on('right', function () {
        if (_this4.right_delay >= _this4.DELAY_DISTANCE) {
          _this4.right_delay = 0;
          var $currentActive = $("#".concat(_this4.currentProd, "-product-360-view-group .image-item.active"));
          var currentCount = $currentActive.data('image');
          var nextCount = currentCount + 1;

          if (currentCount == _this4.IMAGES_NO) {
            nextCount = 1;
          }

          $("#".concat(_this4.currentProd, "-product-360-view-group .image-item[data-image=\"").concat(currentCount, "\"]")).removeClass('active');
          $("#".concat(_this4.currentProd, "-product-360-view-group .image-item[data-image=\"").concat(nextCount, "\"]")).addClass('active');
        } else {
          _this4.right_delay += 1;
        }
      });
      ProductViewPageListener.on('left', function () {
        if (_this4.left_delay >= _this4.DELAY_DISTANCE) {
          _this4.left_delay = 0;
          var $currentActive = $("#".concat(_this4.currentProd, "-product-360-view-group .image-item.active"));
          var currentCount = $currentActive.data('image');
          var nextCount = currentCount - 1;
